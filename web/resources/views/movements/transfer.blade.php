...
@section('content')
    ...
    <form class="form movement-form" action="{{ $editing ? route('movements.update', [$project, $movement]) : route('movements.transfer.store', $project) }}" method="post" data-custom-field-kind="transfer">
        @csrf
